...
DiT checkpoints require `--cond pos_emb.pt,neg_emb.pt` to bake in the fixed text conditioning ComfyUI expects; the script refuses to write a DiT file without it. VAE checkpoints take no `--cond`.
